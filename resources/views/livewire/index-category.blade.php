<div class="py-12">
    ...
    <div class="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex items-center md:items-start justify-between md:h-[450px] overflow-hidden bg-black shadow-sm rounded-md drop-shadow-lg mb-2 md:flex-row flex-col">
